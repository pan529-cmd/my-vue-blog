    ...
    <div class="sidebar">
      <div class="ai-assistant-info">
        <div class="breathing-circle">
          <el-image :src="iconUrl" alt="机器人" style="width: 25px; height: 25px;"></el-image>
        </div>
      ...
      <div class="session-history">
        ...
        <div class="session-list">
          <div @click="handleSessionClick(session)" v-for="session in sessionList" :key="session.id"
            class="session-item">
            <div class="session-info">
              ...
              <div class="session-actions">
                <el-button text type="danger" size="small" @click="handleDeleteClick(session.id)">
                  <el-icon>
                    <DeleteFilled />
                  </el-icon>
                </el-button>
    ...
    <div class="chat-main">
      ...
      <div class="chat-header">
        <div class="header-left">
          <div class="chat-avatar">
            <el-image :src="iconUrl1" alt="用户" style="width: 30px; height: 30px;"></el-image>
          </div>
          <div class="chat-info">
            <h2>宁渡AI助手</h2>
            <p>您贴心的AI心理健康助手</p>
        ...
        <el-button circle size="small" @click="createNewSession">
          <el-icon>
            <Plus />
          </el-icon>
        </el-button>
      ...
      <div class="chat-messages">
        ...
        <div v-if="messages.length === 0" class="message-item ai-message">
          <div class="message-avatar">
            <el-image :src="iconUrl" alt="机器人" style="width: 18px; height: 18px;"></el-image>
          </div>
          <div class="message-content">
            <div class="message-bubble">
              <p>您好！我是小暖，您的心理健康助手。很高心陪伴你，为您提供专业的心理健康服务。请告诉我，今天您感觉怎么样？有什么想要分享的吗？</p>
            </div>
        ...
        <div v-for="item in messages" :key="item.id" class="message-item"
          ...
          <div class="message-avatar">
            <el-image :src="item.senderType === 1 ? iconUrl2 : iconUrl" alt="用户"
          ...
          <div class="message-content">
            <div class="message-bubble">
              ...
              <!-- ai正常回复 -->
              <MarkdownRenderer :markdown="item.content" v-else-if="item.senderType === 2 && !item.content"
                is-ai-message="true" />
              <!-- 用户发送消息 -->
              <p v-else-if="item.content" v-html="formatMessageContent(item.content)"></p>
            </div>
            <div class="message-time">
              {{ item.senderType === 2 && isAiTying ? '正在输入中...' : item.createdAt }}
      ...
      <div class="chat-input">
        <div class="input-container">
          <el-input v-model="userMessage" placeholder="请输入您想要分享的内容..." type="textarea" :rows="3" :disabled="isAiTying"
...
const startAIResponse = (sessionId, message) => {
  ...
  const ctrl = new AbortController()//中止fetch请求的
  // 调用流式接口
  fetchEventSource(`/api/psychological-chat/stream`, {
    ...
    onmessage: (event) => {
      ...
      if (ok && payload.data && payload.data.content) {
        messages.value[messageIndex].content += payload.data.content
      } else {
        // 错误显示
    ...
    onError: (error) => {
      handleError(error.message || '请求错误，请稍后重试')
      throw error
    },
    onclose: () => {
      // 开始情绪分析
