<template>
  <div class="emotion">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column label="记录日期" prop="diaryDate" width="120px" />
      ...
      <el-table-column label="情绪触发因素" prop="emotionTriggers" width="150px" />
      <el-table-column label="日记内容" prop="diaryContent" width="150px" />
      <el-table-column label="操作" width="200" fixed="right">
        <template #default="scope">
          <el-button @click="viewSessionDetail(scope.row)" text type="info">详情</el-button>
          <el-button text type="danger" @click="handleDelete(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination style="margin-top: 25px;" v-model:page-size="pagination.size" :total="pagination.total"
      layout="prev, pager, next" @change="handleChange" />
      ...
      <div class="detail-content" v-if="currentDetail">
        ...
        <div class="detail-section">
          ...
          <el-descriptions :column="2" border>
            ...
            <el-descriptions-item label="主要情绪">
              <el-tag :type="getEmotionTagType(currentDetail.dominantEmotion)" :key="currentDetail.dominantEmotion">{{
        ...
        <div class="detail-section">
          ...
          <div class="ai-analysis-result">
            <el-descriptions :column="2" border>
              <el-descriptions-item label="主要情绪">
                <el-tag :type="getRiskLevelTagType(aiData.primaryEmotion)" :key="aiData.primaryEmotion">{{
              ...
              <el-descriptions-item label="风险等级">
                <el-tag :type="getRiskLevelTagType(aiData.riskLevel)" :key="aiData.riskLevel">{{ aiData.riskLevel
                }}</el-tag>
              </el-descriptions-item>
              <el-descriptions-item label="情绪性质">
                <el-tag :type="aiData.isNegative ? 'danger' : 'success'" :key="aiData.isNegative">{{ aiData.isNegative ?
                  '消极' : '积极' }}</el-tag>
              </el-descriptions-item>
            </el-descriptions>
...
const formItem = [
  { comp: 'input', prop: 'userId', label: '用户ID', placeholderSign: '请输入用户ID' },
  {
    comp: 'select', prop: 'moodScoreRange', label: '情绪评分', placeholderSign: '请选择情绪评分范围', options: [
...
const handleDelete = async (row) => {
  ElMessageBox.confirm(`确认删除${row.title}吗？`,
    '确认',
    {
