      ...
      <div class="diary-card">
        ...
        <div class="detail-form">
          <div class="form-group">
            ...
            <el-input v-model="diaryForm.emotionTriggers" placeholder='今天什么是影响了您的心情' type="textarea" :rows="3"
              :maxlength="1000" show-word-limit></el-input>
          </div>
          <div class="form-group">
            <div class="form-label">今日感想</div>
            <el-input v-model="diaryForm.diaryContent" placeholder='写下今天您的感想，分享您的情感和经历' type="textarea" :rows="5"
